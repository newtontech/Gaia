...
#use("general_relativity.gr_mercury_precession")
// ── 1919 日食观测 ──
...
#claim("eddington_confirms_gr")[
  ...
  Sobral 站测得 $1.98'' plus.minus 0.16''$ @eddington-sobral ，
  与广义相对论预测 @gr-light-deflection 的偏差：
  $ frac(|1.98 - 1.75|, 0.16) approx 1.4 sigma $
  与牛顿预测的偏差：
  $ frac(|1.98 - 0.87|, 0.16) approx 6.9 sigma $
  Príncipe 站测得 $1.61'' plus.minus 0.30''$ @eddington-principe ：
...
#claim_relation("gr_dual_confirmation",
  type: "corroboration",
  between: ("eddington_confirms_gr", "gr_mercury_precession"),
)[光线偏折与水星进动是广义相对论的两个独立预测，
  分别被不同类型的观测所证实。
][
  爱丁顿日食观测 @eddington-confirms-gr 验证了 GR 对光线偏折的预测：
  $ theta_"obs" approx 1.75'' = frac(4 G M, c^2 R) $
  水星进动 @gr-mercury-precession 验证了 GR 对行星轨道的预测：
