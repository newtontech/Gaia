...
#claim_relation("deflection_contradiction",
  ...
  广义相对论 @gr-light-deflection 的完整计算给出：
  $ theta_"GR" = frac(4 G M, c^2 R) = 1.75'' $
  Soldner 的牛顿微粒说 @soldner-deflection 仅含时间弯曲项：
...
#claim("gr_mercury_precession")[
  广义相对论精确解释了水星近日点每世纪 $43''$ 的异常进动，
  无需引入任何新参数。
][
  #premise("einstein_field_equations")
  #premise("mercury_perihelion")

  在 Schwarzschild 度规下 @einstein-field-equations 求解行星轨道，
  广义相对论给出每圈额外进动：
