...
| **Stewart & Buehler 2025** | 2025 | 科学论文推理链 → factor graph | 有（claims with confidence levels） | 有（推理链步骤类型化） | Factor graph | Loopy BP | 论文中提取的置信度 | Bayesian 概率 | 无包模型（单论文） | 无 |
