...
## 8.2 Grim et al. — 科学理论作为贝叶斯网 (2021)

**文献：** Grim, P., Singer, D. J., Bramson, A., Holman, B., McGeehan, S., & Berger, W. J. (2021). Scientific theories as Bayesian nets. *PhilSci-Archive*, ID 19503.
...
**文献：** Stein, M., Kording, K. P., & Senn, S. (2025). BEWA: A Bayesian epistemology of weighted authorities. *arXiv:2506.16015*.

### 核心思想

BEWA（Bayesian Epistemology of Weighted Authorities）是一个非常新的理论框架（2025 年 arXiv 预印本），将科学信念形式化为**结构化科学 claim 上的概率关系**。其核心创新在于：
...
**文献：** Xie, Z., Zhuang, L., et al. (2026). Graph-native cognitive memory with belief revision. *arXiv:2603.17244*.
...
| Grim et al. (2021) | 拓扑结构决定证据传播模式——Gaia 的 DSL 让用户构建这一拓扑 |
