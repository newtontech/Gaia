...
### 6. Gaia vs Grim et al. (2022)

Grim et al.（2022）的"科学理论作为贝叶斯网"是与 Gaia **概念上最接近**的学术工作。两者的核心主张完全一致：科学理论应该被建模为概率图结构，图的拓扑结构决定证据如何传播，概率推理可以回答"在给定所有证据后，这个假设有多可信"。
...
27. Stewart, I. A., & Buehler, M. J. (2026). Higher-Order Knowledge Representations for Agentic Scientific Reasoning. *arXiv:2601.04878*.
...
40. Grim, P., Seidl, F., McNamara, C., Rago, H. E., Astor, I. N., Diaso, C., & Ryner, P. (2022). Scientific Theories as Bayesian Nets: Structure and Evidence Sensitivity. *Philosophy of Science*, 89(5), 927–938.
...
43. Wright, C. S. (2025). Bayesian Epistemology with Weighted Authority: A Formal Architecture for Truth-Promoting Autonomous Scientific Reasoning. *arXiv:2506.16015*.

### I. 补充引用（图原生信念修正）

44. Park, Y. B. (2026). Graph-Native Cognitive Memory for AI Agents: Formal Belief Revision Semantics for Versioned Memory Architectures. *arXiv:2603.17244*.
