...
RegimeAssumption 具有真值且可被质疑。它参与 BP。
...
- **撤回（retraction）**：作者将所有关联 factor 的 probability 设为 0，使知识节点变成孤岛，belief 回到 prior（见第 6 节）。
