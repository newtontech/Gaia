...
Gaia IR 管理 local package 内部的结构。公共协作生态中的 canonicalization 相关信息，来自 package、validated review reports、Official Registry issues、LKM Repo research tasks，以及后续公开的 curation / investigation packages。
