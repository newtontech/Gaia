...
发布流程：
  ...
  3.（可选）向 Official Registry 请求注册（见 04-registry-operations.md）
```
...
这些局限由 Level 1（Official Registry）和 Level 2（LKM Server）解决。见 [04-registry-operations.md](04-registry-operations.md)。
