...
**④ 向 Registry 注册。** Alice 带着 review report 向 Official Registry 请求注册。CI 自动验证编译重现、依赖可解析、review report 合规。经过社区审查等待期后自动合并。
...
- [04 Registry 的运作](04-registry-operations.md) — 注册、去重、推理链激活、增量推理
- [05 审核与策展](05-review-and-curation.md) — Review Server 审核 + LKM curation 的业务逻辑
- [06 多级推理与质量涌现](06-belief-flow-and-quality.md) — 三级推理、错误修正、质量如何涌现
