...
Stages 1-3 correspond to the CLI lifecycle (see [../cli/lifecycle.md](../cli/lifecycle.md)). Stages 4-7 are server-side operations (see [global-canonicalization.md](global-canonicalization.md), [storage.md](storage.md), [curation.md](curation.md), [global-inference.md](global-inference.md)).
...
Working for batch processing of ~5 papers. Stages execute as independent subprocesses coordinated by the orchestrator. The curation stage uses real LLM calls and real embeddings.
