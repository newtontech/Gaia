...
详见 [review-and-curation.md](review-and-curation.md) 中的 LKM Curation 流程和 [decentralized-architecture.md](decentralized-architecture.md) 中的 LKM Repo 和 Open Questions。
...
这些局限由 Layer 1（official repo）和 Layer 2（LKM server）解决。见 [registry-operations.md](registry-operations.md)。
