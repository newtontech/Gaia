...
```mermaid
%%{init: {'theme': 'base', 'flowchart': {'htmlLabels': true, 'nodeSpacing': 44, 'rankSpacing': 60}} }%%
flowchart LR
    subgraph Actors[" "]
        direction TB
    ...
    subgraph GIT["Git Server<br/>GitHub / GitLab / Gitea"]
        ...
        subgraph GitTop[" "]
            direction LR
            PKG["Knowledge Repo<br/>源码 + 编译产物 + review report"]:::pkg
            REG["Official Registry<br/>注册元数据 + belief 结果"]:::registry
        end
        LKMR["LKM Repo<br/>research tasks / issues"]:::lkmrepo
    end
    ...
    style GIT fill:#F8FAFC,fill-opacity:0.64,stroke:#94A3B8,stroke-width:2px,color:#334155

    linkStyle default stroke:#64748B,stroke-width:2px,color:#0F172A
    linkStyle 4,9,10 stroke:#94A3B8,stroke-width:2px,color:#334155
```
