...
审核的详细业务逻辑见 [07-review-and-curation.md](07-review-and-curation.md)。
...
发布流程：
  ...
  3.（可选）向 official repo 请求注册（见 06-registry-operations.md）
```
...
详见 [07-review-and-curation.md](07-review-and-curation.md) 中的 LKM Curation 流程和 [04-decentralized-architecture.md](04-decentralized-architecture.md) 中的 LKM Repo 和 Open Questions。
...
这些局限由 Layer 1（official repo）和 Layer 2（LKM server）解决。见 [06-registry-operations.md](06-registry-operations.md)。
