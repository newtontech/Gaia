...
- **参与 BP**：否。Setting 不携带 probability（无 prior、无 belief），不参与 BP 消息传递。参见 [04-reasoning-strategies.md §1.2](../theory/04-reasoning-strategies.md) 和 [graph-ir.md §1.2](../graph-ir/graph-ir.md)。
