...
Setting 不携带 prior，不参与 BP。可作为 factor 的承载性前提（structural dependency），但不创建 BP 边。对齐 [04-reasoning-strategies.md §1.2](../theory/04-reasoning-strategies.md) 和 [graph-ir.md §1.2](../graph-ir/graph-ir.md)。
