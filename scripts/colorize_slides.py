...
def main():
    ...
    set_colored_text(slide11.shapes[3].text_frame, [
    ...
    set_colored_text(slide12.shapes[3].text_frame, [
    ...
    set_colored_text(slide13.shapes[3].text_frame, [
    ...
    set_colored_text(slide15.shapes[3].text_frame, [
    ...
    set_colored_text(slide16.shapes[3].text_frame, [
    ...
    set_colored_text(slide17.shapes[3].text_frame, [
